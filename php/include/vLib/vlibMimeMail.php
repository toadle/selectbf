...
if (!defined('vlibMimeMailClassLoaded')) {
    ...
    \-----------------------------------------------------------------------------*/
         ...
         * charset.
         *  i.e. $mail->body('ce message est en fran�ais.', 'iso-8859-1');
         *
         ...
         * If you're sending a mail with special characters, be sure to define the
         * charset.
         *  i.e. $mail->htmlbody('ce message est en fran�ais.', 'iso-8859-1');
         *
    ...
    \-----------------------------------------------------------------------------*/
        ...
        function _buildMail () {
            ...
            foreach ($this->xheaders as $head => $value) {
                ...
                if (!ereg('^'.$rgx.'$', $head)) $this->headers .= $head.': '.strtr($value, "\r\n", ' ')."\n";
            }
        }
