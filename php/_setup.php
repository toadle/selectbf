...
{
		SQL_query("CREATE TABLE `selectbf_admin` (  `id` int(10) signed NOT NULL auto_increment,  `name` text,  `value` text,  `inserttime` datetime default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_cache_chartypeusage` (  `kit` varchar(35) NOT NULL default '',  `percentage` float default NULL,  `times_used` int(10) signed default NULL,  PRIMARY KEY  (`kit`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_cache_mapstats` (  `map` varchar(100) NOT NULL default '0',  `wins_team1` int(10) signed default NULL,  `wins_team2` int(10) signed default NULL,  `win_team1_tickets_team1` float default NULL,  `win_team1_tickets_team2` float default NULL,  `win_team2_tickets_team1` float default NULL,  `win_team2_tickets_team2` float default NULL,  `score_team1` int(10) signed default NULL,  `score_team2` int(10) signed default NULL,  `kills_team1` int(10) signed default NULL,  `kills_team2` int(10) signed default NULL,  `deaths_team1` int(10) signed default NULL,  `deaths_team2` int(10) signed default NULL,  `attacks_team1` int(10) signed default NULL,  `attacks_team2` int(10) signed default NULL,  `captures_team1` int(10) signed default NULL,  `captures_team2` int(10) signed default NULL,  PRIMARY KEY  (`map`),  KEY `map` (`map`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_cache_ranking` (  `rank` int(10) signed default NULL,  `player_id` int(10) signed NOT NULL default '0',  `playername` varchar(100) default NULL,  `score` int(10) signed default NULL,  `kills` int(10) signed default NULL,  `deaths` int(10) signed default NULL,  `kdrate` double default NULL,  `score_per_minute` double default NULL,  `tks` int(10) signed default NULL,  `captures` int(10) signed default NULL,  `attacks` int(10) signed default NULL,  `defences` int(10) signed default NULL,  `objectives` int(10) signed default NULL,  `objectivetks` int(10) signed default NULL,  `heals` int(10) signed default NULL,  `selfheals` int(10) signed default NULL,  `repairs` tinyint(3) signed default NULL,  `otherrepairs` tinyint(3) signed default NULL,  `first` tinyint(3) signed default NULL,  `second` tinyint(3) signed default NULL,  `third` tinyint(3) signed default NULL,  `playtime` double default NULL,  `rounds_played` int(10) signed default NULL,  `last_visit` datetime default NULL,  PRIMARY KEY  (`player_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_cache_vehicletime` (  `vehicle` varchar(100) NOT NULL default '',  `time` float default NULL,  `percentage_time` float default NULL,  `times_used` int(10) signed default NULL,  `percentage_usage` float default NULL,  PRIMARY KEY  (`vehicle`),  KEY `vehicle` (`vehicle`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_cache_weaponkills` (  `weapon` varchar(50) NOT NULL default '',  `kills` int(10) signed default NULL,  `percentage` float default NULL,  PRIMARY KEY  (`weapon`),  KEY `weapon` (`weapon`)) TYPE=MyISAM;");
		...
		SQL_query("CREATE TABLE `selectbf_categorymember` (  `member` varchar(50) default NULL,  `category` int(10) signed default NULL) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_chatlog` (  `Id` int(10) signed NOT NULL auto_increment,  `text` text NOT NULL default '',  `player_id` smallint(10) NOT NULL default '0',  `round_id` int(10) default NULL,  `inserttime` datetime default NULL,  PRIMARY KEY  (`Id`)) TYPE=MyISAM;");
		...
		SQL_query("CREATE TABLE `selectbf_cleartext` (  `id` int(10) signed NOT NULL auto_increment,  `original` varchar(50) default NULL,  `custom` varchar(100) default NULL,  `type` varchar(50) default NULL,  `inserttime` datetime default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_drives` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `vehicle` tinytext,  `drivetime` float default '0',  `times_used` int(10) signed default '0',  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_games` (  `id` int(10) signed NOT NULL auto_increment,  `servername` tinytext,  `modid` tinytext,  `mapid` tinytext,  `map` tinytext,  `game_mode` tinytext,  `gametime` int(10) signed default NULL,  `maxplayers` int(10) signed default NULL,  `scorelimit` int(10) signed default NULL,  `spawntime` int(10) signed default NULL,  `soldierff` int(10) signed default NULL,  `vehicleff` int(10) signed default NULL,  `tkpunish` tinyint(3) signed default NULL,  `deathcamtype` tinyint(3) signed default NULL,  `starttime` datetime default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`)) TYPE=MyISAM;");
		...
		SQL_query("CREATE TABLE `selectbf_kills_player` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `victim_id` int(10) signed default NULL,  `times_killed` int(10) signed default '0',  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`,`victim_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_kills_weapon` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `weapon` varchar(50) default '0',  `times_used` int(10) signed default '0',  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`,`weapon`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_kits` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `kit` text,  `times_used` int(10) signed default '0',  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_modassignment` (  `id` int(10) signed NOT NULL auto_increment,  `item` varchar(50) default NULL,  `mod` varchar(50) default NULL,  `type` varchar(50) default NULL,  `inserttime` datetime default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_nicknames` (  `nickname` varchar(150) default NULL,  `times_used` int(10) signed default NULL,  `player_id` int(10) signed default NULL,  KEY `player_id` (`player_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_params` (  `id` int(10) signed NOT NULL auto_increment,  `name` varchar(50) default NULL,  `value` varchar(255) default NULL,  `inserttime` datetime default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_players` (  `id` int(10) signed NOT NULL auto_increment,  `name` varchar(150) default NULL,  `keyhash` varchar(32) NOT NULL default '',  `inserttime` datetime default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_playerstats` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `team` tinyint(3) signed default NULL,  `score` int(10) signed default NULL,  `kills` int(10) signed default NULL,  `deaths` int(10) signed default NULL,  `tks` int(10) signed default NULL,  `captures` int(10) signed default NULL,  `attacks` int(10) signed default NULL,  `defences` int(10) signed default NULL,  `objectives` int(10) signed default NULL,  `objectivetks` int(10) signed default NULL,  `heals` int(10) signed default NULL,  `selfheals` int(10) signed default NULL,  `repairs` tinyint(3) signed default NULL,  `otherrepairs` tinyint(3) signed default NULL,  `round_id` int(10) signed default NULL,  `first` tinyint(3) signed default NULL,  `second` tinyint(3) signed default NULL,  `third` tinyint(3) signed default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`,`round_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_playtimes` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `last_seen` datetime default NULL,  `playtime` float default '0',  `slots_used` int(10) signed default '0',  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`)) TYPE=MyISAM;");
		...
		SQL_query("CREATE TABLE `selectbf_rounds` (  `id` int(10) signed NOT NULL auto_increment,  `start_tickets_team1` int(10) signed default NULL,  `start_tickets_team2` int(10) signed default NULL,  `starttime` datetime default NULL,  `end_tickets_team1` int(10) signed default NULL,  `end_tickets_team2` int(10) signed default NULL,  `endtime` datetime default NULL,  `endtype` tinytext,  `winning_team` tinyint(3) signed default '0',  `game_id` int(10) signed default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`game_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_selfkills` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `times_killed` int(10) signed default NULL,  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`)) TYPE=MyISAM;");
		SQL_query("CREATE TABLE `selectbf_tks` (  `id` int(10) signed NOT NULL auto_increment,  `player_id` int(10) signed default NULL,  `victim_id` int(10) signed default NULL,  `times_killed` int(10) signed NOT NULL default '0',  PRIMARY KEY  (`id`),  UNIQUE KEY `id` (`id`),  KEY `id_2` (`id`,`player_id`,`victim_id`)) TYPE=MyISAM;");
