...
function createAllTables()
{
		...
		SQL_query("CREATE TABLE `selectbf_cache_chartypeusage` (  `kit` varchar(255) NOT NULL default '',  `percentage` float default NULL,  `times_used` int(10) signed default NULL,  PRIMARY KEY  (`kit`)) TYPE=MyISAM;");
		...
		SQL_query("CREATE TABLE `selectbf_chatlog` (  `Id` int(10) signed NOT NULL auto_increment,  `text` text NOT NULL,  `player_id` smallint(10) NOT NULL default '0',  `round_id` int(10) default NULL,  `inserttime` datetime default NULL,  PRIMARY KEY  (`Id`)) TYPE=MyISAM;");
